...
class ModelAsignacionJurados(models.Model):
    proyecto_final = models.ForeignKey(
        ModelProyectoFinal, on_delete=models.CASCADE, related_name='Jurados', blank=True, null=True)
...
class ModelActividades(models.Model):
    objetivo_general = models.ForeignKey(
        ModelObjetivoGeneral, on_delete=models.CASCADE, related_name="actividades", blank=True, null=True)
