...
urlpatterns = [
    ...
    path('editar_eliminar_archivo/<int:id>', views.editar_eliminar_archivo,
         name='editar_eliminar_archivo'),
    path('subir_actividad/<int:id_proyecto>/<int:id_esp>', views.subir_actividad,
    ...
    path('subir_avance/<int:id_esp>', views.subir_avance,
         name='subir_avance'),
    ################################################################################
